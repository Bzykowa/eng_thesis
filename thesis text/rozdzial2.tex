...
\begin{algorithm}[H]
    ...
    \Begin{
        ...
        \;
        Włącz powiadomienia na $settingsChar, batteryChar, eventsChar$\;
        Odczytaj wartość z $serialNumChar, hardwareChar, softwareChar$ oraz $batteryChar$\;
        Ustaw język angielski poprzez wysłanie $ByteArray(0x06, 0x17, 0x00, 0x65, 0x6e, 0x5f, 0x55, 0x53) do settingsChar$ \;
        Wyłącz odblokowywanie ekranu w opasce poprzez wysłanie $ $\;
        Wyłącz tryb nocny poprzez wysłanie $ $\;
        Ustaw format daty na DD_MM_YYYY poprzez wysłanie $ $\;
        Ustaw format daty na Date_Time poprzez wysłanie $ $\;
        Ustaw 24-godzinny zegar poprzez wysłanie $ $\;
        Ustaw przykładowe dane o użytkowniku poprzez wysłanie $ $\;
